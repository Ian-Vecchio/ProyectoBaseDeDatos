...
<body>
    ...
    <div class="contenedor-fondo">
        ...
        <div class="conteiner_de_productos">
            ...
            $sql_admin = "CALL salida_info_usuario($id_usuario_producto)";
            $consulta_admin = mysqli_query($conexion, $sql_admin);

            if ($consulta_admin) {
                $consulta_hecha = mysqli_fetch_assoc($consulta_admin);
                $rol = $consulta_hecha['rol']; 
    
                mysqli_free_result($consulta_admin);
